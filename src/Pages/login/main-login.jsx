                ...
                <div className={styles.boxLeft}>
                        <div className={styles.rowOne}>
                            <div className={styles.boxOne}>   
                                <h1 className={styles.nameboxOne}> Vũ Đình Ngọc </h1>                            
                             </div>
                        ...
                        <div className={styles.rowTwo}>
                                 ...
                                 <h1 className={styles.textTwo}>  Để không bỏ lỡ các ưu đãi hấp dẫn từ Vũ Đình Ngọc </h1>
                        </div>
                ...
                <div className={styles.boxRight}>
                    ...
                    <div className={styles.boxInput}>
                        ...
                        <div className={styles.boxInput__three}>
                                Trải nghiệm đăng nhập liền mạch với Vũ Đình Ngọc ưu tiên dùng tài khoản Vũ Đình Ngọc(nếu có)
                        </div>
